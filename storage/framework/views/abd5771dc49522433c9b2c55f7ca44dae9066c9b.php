        ...
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <div style="background:#fff; padding:20px; border-radius:8px; width:500px; max-width:90%;">
                                                        ...
                                                        <button type="button" class="btn btn-secondary" id="formulaCloseBtn">
                                                            Close
                                                        </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <button type="button" class="btn btn-primary" id="paymentPlanSubmitBtn">
                                                    <i class="ti ti-check me-2"></i>Submit
                                                </button>
                                                <button type="button" class="btn btn-secondary" id="paymentPlanResetBtn">
                        ...
                        <div class="mt-4" id="slipPreviewSection" style="display:none;">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <button type="button" class="btn btn-success me-2" id="printSlipBtn">
                                            <i class="ti ti-printer me-2"></i>Print Slip
                                        </button>
                                        <button type="button" class="btn btn-info me-2" id="downloadSlipBtn">
...
if (sltLoanAppliedField) {
    ...
    const paymentPlanSubmitBtn = document.getElementById('paymentPlanSubmitBtn');
    if (paymentPlanSubmitBtn) {
        paymentPlanSubmitBtn.addEventListener('click', createPaymentPlan);
    }

    const paymentPlanResetBtn = document.getElementById('paymentPlanResetBtn');
    if (paymentPlanResetBtn) {
        paymentPlanResetBtn.addEventListener('click', resetPaymentPlanForm);
    }

    const generateSlipBtn = document.getElementById('generateSlipBtn');
    if (generateSlipBtn) {
        generateSlipBtn.addEventListener('click', generatePaymentSlip);
    }

    const printSlipBtn = document.getElementById('printSlipBtn');
    if (printSlipBtn) {
        printSlipBtn.addEventListener('click', printPaymentSlip);
    }

    const downloadSlipBtn = document.getElementById('downloadSlipBtn');
    if (downloadSlipBtn) {
        downloadSlipBtn.addEventListener('click', downloadPaymentSlip);
    }

    const loadPaymentRecordsBtn = document.getElementById('loadPaymentRecordsBtn');
    if (loadPaymentRecordsBtn) {
        loadPaymentRecordsBtn.addEventListener('click', loadPaymentRecords);
    }
    ...
    const updatePaymentRecordsBtn = document.getElementById('updatePaymentRecordsBtn');
    if (updatePaymentRecordsBtn) {
        updatePaymentRecordsBtn.addEventListener('click', updatePaymentRecords);
    }

    const generatePaymentSummaryBtn = document.getElementById('generatePaymentSummaryBtn');
    if (generatePaymentSummaryBtn) {
        generatePaymentSummaryBtn.addEventListener('click', generatePaymentSummary);
    }

    const slipStudentIdInput = document.getElementById('slip-student-id');
    if (slipStudentIdInput) {
        slipStudentIdInput.addEventListener('change', checkStudentAndCourse);
    }

    const slipCourseSelect = document.getElementById('slip-course');
    if (slipCourseSelect) {
        slipCourseSelect.addEventListener('change', loadIntakesForCourse);
    }

    const slipPaymentTypeSelect = document.getElementById('slip-payment-type');
    if (slipPaymentTypeSelect) {
        slipPaymentTypeSelect.addEventListener('change', function() {
            loadPaymentDetails();
            setTimeout(toggleLateFeeColumn, 300);
        });
    }

    const summaryStudentNicInput = document.getElementById('summary-student-nic');
    if (summaryStudentNicInput) {
        summaryStudentNicInput.addEventListener('change', loadStudentCoursesForSummary);
    }
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\thisali\Nebula-Main\resources\views/payment.blade.php ENDPATH**/ ?>
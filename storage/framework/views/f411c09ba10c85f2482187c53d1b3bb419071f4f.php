        ...
        <div class="mb-3 text-center position-relative">
            <div class="d-flex justify-content-end">
                <div class="rounded-circle overflow-hidden mx-auto mb-3 position-relative" style="width: 150px; height: 150px; border: 2px solid #ccc;">
                    <img src="<?php echo e(asset('images/profile/user-1.jpg')); ?>" alt="User Profile" class="w-100 h-100 object-cover" id="profilePicture">
                </div>
            </div>
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\danid\Desktop\Clony-17\resources\views/user_profile.blade.php ENDPATH**/ ?>
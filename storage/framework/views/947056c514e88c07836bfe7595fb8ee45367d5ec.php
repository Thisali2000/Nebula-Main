    ...
    document.getElementById('courseForm').addEventListener('submit', function(e) {
        ...
        document.querySelectorAll('#students_table tbody tr').forEach(row => {
            selectedStudents.push({
                ...
                original_status: row.dataset.originalStatus   // ✅ added
            });
        });
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/nebula final/Nebula/resources/views/semester_registration.blade.php ENDPATH**/ ?>
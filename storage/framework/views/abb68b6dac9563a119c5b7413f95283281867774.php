                ...
                <table class="table table-striped table-bordered table-hover" style="table-layout: fixed; width: max-content; min-width: 900px;">
                    ...
                    <tbody id="existingCoursesTableBody">
                        ...
                        <tr data-course-id="<?php echo e($course->course_id); ?>">
                            <td>
                                <input type="checkbox" class="form-check-input course-checkbox" data-course-id="<?php echo e($course->course_id); ?>">
                            </td>
                            <td class="course-name"><?php echo e($course->course_name); ?></td>
                            <td class="course-type" data-type="<?php echo e($course->course_type); ?>">
                            ...
                            <td class="course-location"><?php echo e($course->location); ?></td>
                            <td class="course-duration"><?php echo e($course->duration_formatted); ?></td>
                            <td class="course-medium"><?php echo e($course->course_medium); ?></td>
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <button class="btn btn-outline-primary edit-course-btn" data-course-id="<?php echo e($course->course_id); ?>" title="Edit">
                                        <i class="ti ti-edit"></i>
                                    </button>
                                    <button class="btn btn-outline-danger delete-course-btn" data-course-id="<?php echo e($course->course_id); ?>" title="Delete">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/nebula final/Nebula/resources/views/course_management.blade.php ENDPATH**/ ?>
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nic" name="nic"
                                placeholder="Enter NIC or search...">
                        </div>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="mb-4" id="notEligibleOptions" style="display:none;">
                    <button class="btn btn-outline-primary me-2" id="registerAnotherCourseBtn">Register for Another
                        Course</button>
                    ...
                    setTimeout(() => {
                        ...
                        fetch(`/get-registered-courses-by-nic?nic=${encodeURIComponent(nic)}`)
                            ...
                            .then(data => {
                                ...
                                // ⛔ Handle terminated / not found / error cases
                                if (!data.success) {
                                    if (data.message) {
                                        // uses your showToast() defined below in the view
                                    ...
                                    const details = document.getElementById('studentDetailsSection');
                                    const actions = document.getElementById('eligibilityActionButtons');
                                    if (details) details.style.display = 'none';
                                    if (actions) actions.style.display = 'none';
                                    return;
                                }

                                // ✅ Success: populate course dropdown
                                if (data.courses) {
                                    courseSelect.innerHTML = `<option selected disabled value="">Select a course</option>`;
                                    ...
                                    // Select pending course if present
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="specialApprovalForm">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-3 col-form-label fw-bold">Upload Document<span
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SLT\Welisara\Nebula\resources\views/eligibility_registration.blade.php ENDPATH**/ ?>
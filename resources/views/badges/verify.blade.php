            ...
            <div class="credentials-section">
                ...
                <div class="credential-grid">
                    <div class="credential-item">
                        ...
                        <div class="credential-value">{{ $badge->student->full_name}} {{ $badge->student->last_name }}</div>
                    </div>

                    <div class="credential-item">
                        <div class="credential-label">Course Program</div>
                        <div class="credential-value">{{ $badge->course->course_name }}</div>
                    </div>

                    <div class="credential-item">
                        <div class="credential-label">Program Type</div>
                        <div class="credential-value">{{ ucfirst($badge->course->course_type) }}</div>
                    </div>

                    <div class="credential-item">
                        <div class="credential-label">Batch Intake</div>
                        <div class="credential-value">{{ $badge->intake->batch ?? 'N/A' }}</div>
                    </div>

                    <div class="credential-item">
                        <div class="credential-label">Issue Date</div>
                        <div class="credential-value">{{ \Carbon\Carbon::parse($badge->issued_date)->format('d M Y') }}</div>
                    </div>
                    ...
                    <div class="credential-item verification-code-item">
                        ...
                        <div class="credential-value">{{ $badge->verification_code }}</div>
                    </div>
                </div>
            </div>

            <div class="action-section">
                <a href="{{ asset('storage/' . $badge->badge_image_path) }}" 

...
<div class="container-fluid">
    <div class="card">
        ...
        <th class="text-center">Approved Late Fee</th> <!-- 👈 New -->
...
function displayPaymentPlan(paymentPlan) {
    ...
    const row = `
        <tr>
            ...
            <td class="text-center">
                LKR ${parseFloat(installment.late_fee || 0).toLocaleString()}
            </td>
            <td class="text-center">
                ${installment.approved_late_fee > 0 
                    ? `<span class="text-success">LKR ${parseFloat(installment.approved_late_fee).toLocaleString()}</span>` 
                    : '<span class="text-muted">-</span>'
                }
            </td>
            <td class="text-center fw-bold">
                LKR ${parseFloat(installment.total_due || 0).toLocaleString()}
            </td>
        </tr>
    `;
